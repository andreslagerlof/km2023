...
description: "Spänningen höjde temperaturen ytterligare några grader över kokpunkten i KMs deltävling 2 när inte mindre än 28 fäktare kämpade för ära och berömmelse. Denna gång kunde publiken också glädjas att se landslagsfäktarna Linus från Uppsala och Christopher visa upp sina färdigheter på pisten."
execute:
  echo: false
  warning: false
---
...
Den andra deltävlingen bjöd,liksom förra gången, publiken på spännande nyheter. Inte minst med en rad debutanter som Thomas, Mathias, Lucas, Ludvig, Vendela, Otis och Marco som alla gjorde säsongspremiär. Dessutom fick klubben celebert besök av landslagsfäktarna Linus och Christopher som också de debuterade för året. Tillsammans var det inte mindre än 28 fäktare som med brinnande entusiasm gjorde tävlingen till fäktfest.
...
Som gäster tog det inte lång tid för Linus och Christopher att känna sig väl hemmastadda och utan närmare ceremonier började de sluka segrar med god aptit. Båda lyckades med konsttycket att rada upp hela 24 segrar var och efter stöträkning kunde Christopher belåtet konstatera att han därmed tagit hand om 2:a platsen framför Linus som således slutade som 3:a, även det en fin prestation. Grattis och välkomna åter!

## De unga vinner terräng

Återigen förstärker de yngre fäktarna sina positioner. Detta bevisade både Vedran, Ian, Lucas med en 4:e till 6:e plats i nämnd ordning. Sensationsmannen Elvin, som vann söndagens tävling i Örebro helgen innan, följde upp med en stark 7:e plats.
